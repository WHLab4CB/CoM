...
for i in range(n_value):
    ...
    term_1 = np.abs(np.log10(c_value_1[i]+epsilon) + np.log10(1.0-c_value_1[i]+epsilon))
    term_2 = np.abs(np.log10(c_value_2[i]+epsilon) + np.log10(1.0-c_value_2[i]+epsilon))
