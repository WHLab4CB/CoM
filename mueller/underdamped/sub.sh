...
cp ./data/samples_cell.txt ./test_0
...
cp ./data/samples_cell.txt ./test_$i
...
cd plot
python3 ./plot_sample_iso_c.py
cd ..

cp ./data/committor_*samples.dat ./test_mfpt
cp ./data/reactant_samples.dat ./test_mfpt
cp ./data/product_samples.dat ./test_mfpt
cp ./data/Kmat.dat.simulate ./test_mfpt
cp ./data/lifetime.dat ./test_mfpt
cp ./data/mfpt.txt ./test_mfpt
cp ./plot/sample_iso_c.png ./test_mfpt
